...
# code generated by ChatGPT, explanation via comments and docstrings added by Tuyen
"""
split_spreads.py
...
SMOOTH_KERNEL = 51  # must be odd; increase if noisy
